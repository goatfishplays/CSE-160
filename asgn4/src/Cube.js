...
class Cube {
    ...
    generateCube(frontBLTR, backBLTR, leftBLTR, rightBLTR, topBLTR, bottomBLTR) {
        ...
        this.shaderInfo = new Float32Array([
            // front
            0.5, -0.5, -0.5, frontBLTR[3], frontBLTR[0], 0.0, 0.0, -1.0,
            0.5, 0.5, -0.5, frontBLTR[3], frontBLTR[2], 0.0, 0.0, -1.0,
            -0.5, -0.5, -0.5, frontBLTR[1], frontBLTR[0], 0.0, 0.0, -1.0,
            0.5, 0.5, -0.5, frontBLTR[3], frontBLTR[2], 0.0, 0.0, -1.0,
            -0.5, 0.5, -0.5, frontBLTR[1], frontBLTR[2], 0.0, 0.0, -1.0,
            -0.5, -0.5, -0.5, frontBLTR[1], frontBLTR[0], 0.0, 0.0, -1.0,

            // back
            0.5, -0.5, 0.5, backBLTR[3], backBLTR[0], 0.0, 0.0, 1.0,
            0.5, 0.5, 0.5, backBLTR[3], backBLTR[2], 0.0, 0.0, 1.0,
            -0.5, -0.5, 0.5, backBLTR[1], backBLTR[0], 0.0, 0.0, 1.0,
            0.5, 0.5, 0.5, backBLTR[3], backBLTR[2], 0.0, 0.0, 1.0,
            -0.5, 0.5, 0.5, backBLTR[1], backBLTR[2], 0.0, 0.0, 1.0,
            -0.5, -0.5, 0.5, backBLTR[1], backBLTR[0], 0.0, 0.0, 1.0,

            // top
            -0.5, 0.5, -0.5, topBLTR[1], topBLTR[0], 0.0, 1.0, 0.0,
            0.5, 0.5, 0.5, topBLTR[3], topBLTR[2], 0.0, 1.0, 0.0,
            -0.5, 0.5, 0.5, topBLTR[1], topBLTR[2], 0.0, 1.0, 0.0,
            -0.5, 0.5, -0.5, topBLTR[1], topBLTR[0], 0.0, 1.0, 0.0,
            0.5, 0.5, 0.5, topBLTR[3], topBLTR[2], 0.0, 1.0, 0.0,
            0.5, 0.5, -0.5, topBLTR[3], topBLTR[0], 0.0, 1.0, 0.0,

            // bottom
            -0.5, -0.5, -0.5, bottomBLTR[1], bottomBLTR[0], 0.0, -1.0, 0.0,
            0.5, -0.5, 0.5, bottomBLTR[3], bottomBLTR[2], 0.0, -1.0, 0.0,
            -0.5, -0.5, 0.5, bottomBLTR[1], bottomBLTR[2], 0.0, -1.0, 0.0,
            -0.5, -0.5, -0.5, bottomBLTR[1], bottomBLTR[0], 0.0, -1.0, 0.0,
            0.5, -0.5, 0.5, bottomBLTR[3], bottomBLTR[2], 0.0, -1.0, 0.0,
            0.5, -0.5, -0.5, bottomBLTR[3], bottomBLTR[0], 0.0, -1.0, 0.0,
            ...
            0.5, 0.5, -0.5, rightBLTR[3], rightBLTR[0], 1.0, 0.0, 0.0,
            0.5, 0.5, 0.5, rightBLTR[3], rightBLTR[2], 1.0, 0.0, 0.0,
            0.5, -0.5, -0.5, rightBLTR[1], rightBLTR[0], 1.0, 0.0, 0.0,
            0.5, 0.5, 0.5, rightBLTR[3], rightBLTR[2], 1.0, 0.0, 0.0,
            0.5, -0.5, 0.5, rightBLTR[1], rightBLTR[2], 1.0, 0.0, 0.0,
            0.5, -0.5, -0.5, rightBLTR[1], rightBLTR[0], 1.0, 0.0, 0.0,
            ...
            -0.5, 0.5, -0.5, leftBLTR[3], leftBLTR[0], -1.0, 0.0, 0.0,
            -0.5, 0.5, 0.5, leftBLTR[3], leftBLTR[2], -1.0, 0.0, 0.0,
            -0.5, -0.5, -0.5, leftBLTR[1], leftBLTR[0], -1.0, 0.0, 0.0,
            -0.5, 0.5, 0.5, leftBLTR[3], leftBLTR[2], -1.0, 0.0, 0.0,
            -0.5, -0.5, 0.5, leftBLTR[1], leftBLTR[2], -1.0, 0.0, 0.0,
            -0.5, -0.5, -0.5, leftBLTR[1], leftBLTR[0], -1.0, 0.0, 0.0,
        ])
    }
